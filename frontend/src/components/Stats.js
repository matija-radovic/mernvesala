...
const Stats = () => {
    ...
    const [stats, setStats] = useState({
        "games won": `${userData.user.stats.gamesWon} of ${userData.user.stats.gamesPlayed}`,
        "win percentage": `${userData.user.stats.gamesPlayed !== 0 ? (Math.round(userData.user.stats.gamesWon / userData.user.stats.gamesPlayed * 10000)/100) : "0"}%`,
        ...
        "guessing percentage": `${userData.user.stats.guessAttempts !== 0 ? (Math.round((userData.user.stats.lettersGuessed + userData.user.stats.wordsGuessed) / userData.user.stats.guessAttempts * 10000)/100) : "0"}%`,
